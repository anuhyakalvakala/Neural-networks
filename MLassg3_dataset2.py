...
data = datasets.fetch_openml(data_id=1460)
...
import scipy
no_hidden = scipy.stats.ttest_ind(test_fold_accuracy_two_hidden,test_fold_accuracy)
less_dense = scipy.stats.ttest_ind(test_fold_accuracy_two_hidden,test_fold_accuracy_less_dense)
high_dense = scipy.stats.ttest_ind(test_fold_accuracy_two_hidden,test_fold_accuracy_high_dense)
